        ...
        data.forEach(product => {
            ...
            const makePriceLink = (priceText, type = null) => {
                ...
                if (type === 'high' || type === 'low') {
                    ...
                    return `<a href="javascript:void(0)" onclick="window.showSellerNotification('${type === 'high' ? 'Market Highest' : 'Market Lowest'}', '${product.product_name.replace(/'/g, "\\'")}', '${priceText}', '${seller.replace(/'/g, "\\'")}')" class="price-link" style="color: inherit; text-decoration: none; border-bottom: 1px dashed rgba(255,255,255,0.3); padding-bottom: 2px;" title="View Seller Info" onmouseover="this.style.borderBottom='1px solid var(--accent-primary)'" onmouseout="this.style.borderBottom='1px dashed rgba(255,255,255,0.3)'">${priceText}</a>`;
                }
