...
listings = agent._search_bing_html(query1)
print(f"Bing HTML listings for '{query1}':")
...
broad_listings = agent._search_bing_html(query2)
print(f"\nBing HTML broad listings for '{query2}':")
